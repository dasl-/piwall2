...
. Requires raspbian lite https://github.com/dasl-/piwall2/blob/main/docs/tv_output_options.adoc#note-on-os-support[bullseye] (a legacy OS): https://downloads.raspberrypi.com/raspios_oldstable_lite_armhf/images/raspios_oldstable_lite_armhf-2024-10-28/[2024-10-22-raspios-bullseye-armhf-lite.img]
