...
For reference, I was testing with this video: https://www.youtube.com/watch?v=rSLQ--jza5U . Maybe one out of every five attempts it would take ~20 - 22 seconds to start the youtube-dl download.
